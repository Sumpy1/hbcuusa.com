  ...
  return (
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-gray-100 dark:bg-gray-800 p-8 font-body">
        ...
        <section class="image-section mt-8">
          <img src="img/9404239828_0443447145_o.jpg" alt="picture" class="w-full max-w-lg mx-auto rounded-lg shadow-md"/>
        </section>
        ...
        <section className="mission-vision mt-8">
          ...
          <h2 className="text-2xl font-bold mb-4 mt-8 dark:text-white">Our Vision</h2>
          <p className="text-gray-700 dark:text-gray-300">
